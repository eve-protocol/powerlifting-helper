...
*Structure aligned with Volume/Strength blocks*
...
| Days per week | 5 |
| Total workouts | 20 |
| Mock Meet | Week 4, Day 5 |

## Weekly Structure

| Day | Focus | Main Lifts |
|-----|-------|------------|
| Mon | Heavy Squat | Squat (Low Bar) / Bench Press (Paused) / 2 acc |
| Tue | DL Variation | Sumo Deadlift (Paused) / Incline DB Bench / 2 acc |
| Wed | Squat Variation | Tempo Squat / 4 acc |
| Thu | Heavy Bench | Bench Press (Barbell) / RDL / 2 acc |
| Sat | Heavy Deadlift | Sumo Deadlift / Squat (lighter) / Spoto Press / 1 acc |
...
### Week 4 (Taper + Mock Meet)

#### Day 1 (Monday) - Openers
...
| # | Exercise | Attempt 1 | Attempt 2 | Attempt 3 |
|---|----------|-----------|-----------|-----------|
| 1 | Squat (Low Bar) | 1x1 @RPE 8 | 1x1 @RPE 9 | 1x1 @RPE 10 |
| 2 | Bench Press (Barbell) | 1x1 @RPE 8 | 1x1 @RPE 9 | 1x1 @RPE 10 |
| 3 | Sumo Deadlift (Barbell) | 1x1 @RPE 8 | 1x1 @RPE 9 | 1x1 @RPE 10 |

**Mock Meet Protocol:**
- Warm up as you would for a real meet
- 10-15 min rest between lifts
- Attempt 1: Opener - something you can triple on a bad day (~88-90%)
- Attempt 2: Build confidence - moderate jump (~95-97%)
- Attempt 3: Go for it - PR attempt (100%+)

---

## Notes

- **Accessories:** Reduced volume throughout, capped at RPE 7 to preserve recovery
- **Week 3:** Peak intensity week - don't add weight to accessories
- **Week 4:** Full taper - everything is light, save energy for Day 5
- **Sleep:** Prioritize 7-8 hours, especially Week 3-4
- **Nutrition:** Don't cut weight, stay at 77-78kg, fuel the lifts
